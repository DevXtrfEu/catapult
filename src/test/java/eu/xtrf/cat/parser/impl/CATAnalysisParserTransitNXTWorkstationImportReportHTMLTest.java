...
@Test
public class CATAnalysisParserTransitNXTWorkstationImportReportHTMLTest extends CATAnalysisParserTest<CATAnalysisParserTransitNXTWorkstationImportReportHTML> {

	public CATAnalysisParserTransitNXTWorkstationImportReportHTMLTest() {
		super(CATAnalysisParserTransitNXTWorkstationImportReportHTML.class);
	}	
	...
	public Object[][] getFiles() {
		...
		return new Object[][] {
			new Object[] {"/transit/01.html", result1},
			new Object[] {"/transit/02.html", result2},
			new Object[] {"/transit/03.html", result3},
			new Object[] {"/transit/04.html", result4},
		};
	}
